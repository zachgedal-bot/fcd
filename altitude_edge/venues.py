...
VENUES = {
    ...
    # ---------------- NWSL (home venues; only Utah and Denver sit above 1,000 m) ----------------
    "Angel City FC": ("Los Angeles", 50, "NWSL"),
    "Bay FC": ("San Jose", 25, "NWSL"),
    "Boston Legacy FC": ("Boston", 5, "NWSL"),
    "Chicago Stars FC": ("Bridgeview", 180, "NWSL"),
    "Denver Summit FC": ("Denver", 1600, "NWSL"),
    "Houston Dash": ("Houston", 15, "NWSL"),
    "KC Current": ("Kansas City", 270, "NWSL"),
    "NC Courage": ("Cary", 120, "NWSL"),
    "NJ/NY Gotham": ("Harrison", 5, "NWSL"),
    "Orlando Pride": ("Orlando", 30, "NWSL"),
    "Portland Thorns": ("Portland", 15, "NWSL"),
    "Rac. Louisville": ("Louisville", 140, "NWSL"),
    "San Diego Wave": ("San Diego", 20, "NWSL"),
    "Seattle Reign": ("Seattle", 5, "NWSL"),
    "Utah Royals FC": ("Sandy", 1350, "NWSL"),
    "Washington Spirit": ("Washington", 5, "NWSL"),
...
ALIASES = {
    ...
    "gotham": "NJ/NY Gotham",
    "racing louisville": "Rac. Louisville",
    "racing louisville fc": "Rac. Louisville",
